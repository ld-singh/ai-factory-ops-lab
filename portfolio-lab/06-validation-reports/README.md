...
| [hami-gpu-operator-coexistence-validation.md](./hami-gpu-operator-coexistence-validation.md) | [6 - Real GPU](../real-gpu-session/README.md) (Part C - HAMi + GPU Operator) | 🟥 Real | 🟡 Pending the Part C hardware run (`capture-evidence.sh`) |
